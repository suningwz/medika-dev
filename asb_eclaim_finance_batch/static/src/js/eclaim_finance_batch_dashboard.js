odoo.define('asb_eclaim_finance_batch.eclaim_batch_finance_dashboard', function (require) {
    "use strict";
    ...
    let dashboardValues;
    SampleServer.mockRegistry.add('eclaim.batch/retrieve_eclaim_finance_dashboard', () => {
    ...
    var EclaimFinanceListDashboardRenderer = ListRenderer.extend({
        ...
        _renderView: function () {
            ...
            return this._super.apply(this, arguments).then(function () {
                ...
                var eclaim_finance_batch_dashboard = $(QWeb.render('asb_eclaim_finance_batch.EclaimFinanceBatchDashboard', {
                    values: values,
                }));
                eclaim_finance_batch_dashboard.find('.o_dashboard_action').on('click', self._onDashboardActionClicked.bind(self))
                self.$el.before(eclaim_finance_batch_dashboard);
            });
        },
