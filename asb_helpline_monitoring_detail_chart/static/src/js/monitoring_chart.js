odoo.define('asb_helpline_monitoring_detail_chart.MonitoringChart', function (require) {
    'use strict';
    ...
    var MonitoringChart = qweb.Renderer.extend({
        async _render() {
            ...
            this.render_monitoring_detail_chart(this.active_id);
        },

        render_monitoring_detail_chart: function (active_id) {
            var self = this;
            rpc.query({
